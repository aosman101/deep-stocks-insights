...
Purpose : N-HiTS + TFT + LightGBM market prediction platform
...
API Groups:
  ...
  /api/predictions — Shared ML model predictions
...
app = FastAPI(
    ...
    description=(
        ...
        "N-HiTS, TFT, and LightGBM predictions are available depending on asset support. "
